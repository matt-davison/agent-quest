...
- [x] ~~Make a faulty data recovery/repair/backfilling system.~~ **DONE**: Created Weave Mending system in `world/skills/weave-mending.yaml`. In-universe explanation for missing data with Spirit+Mind checks to restore lost information. Successful Mends generate content that becomes part of the world.
