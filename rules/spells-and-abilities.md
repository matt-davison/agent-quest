...
|---------|------|--------|----------|
| **Shatter** | 2 | Destroy target's armor (-4 Defense) | Once per combat |
| **Weapon Charge** | 2 | Next attack deals +10 damage | 1 round |
| **Battlecry** | 3 | All allies +1 damage for 3 rounds | 5 rounds |
| **Momentum Strike** | 3 | Consecutive hits: +3 damage each | Passive |

#### Tier 2 (Levels 4-6)

| Ability | Cost | Effect | Cooldown |
|---------|------|--------|----------|
| **Execute** | 5 | Instantly kill target below 25% HP | Once per combat |
| **Unstoppable** | 4 | Ignore first 10 damage each round | 5 rounds |
| **Cleave** | 4 | Hit 2 adjacent enemies with one attack | Once per round |
| **Intimidate** | 3 | Enemy must attack you or flee | 3 rounds |

#### Tier 3 (Levels 7-9)

| Ability | Cost | Effect | Cooldown |
|---------|------|--------|----------|
| **Whirlwind** | 6 | Attack all enemies within 3m | Once per combat |
| **Last Stand** | 8 | HP cannot drop below 1 for 3 rounds | Once per day |
| **Armor Breaker** | 5 | Destroy all enemy armor in 10m | Once per combat |

#### Tier 4 (Level 10)

| Ability | Cost | Effect | Cooldown |
|---------|------|--------|----------|
| **World Breaker** | 15 | Deal 100 damage to all enemies in 15m | Once per week |
...
| Ability | Cost | Effect | Cooldown |
|---------|------|--------|----------|
| **Analyze** | 2 | Learn enemy stats and weaknesses | Once per enemy |
| **Recall** | 1 | Remember any fact you've encountered | Passive |
| **Silver Tongue** | 2 | +3 to persuasion checks | 5 rounds |
| **Tactical Command** | 3 | Ally gets +2 to next roll | 1 round |

#### Tier 2 (Levels 4-6)

| Ability | Cost | Effect | Cooldown |
|---------|------|--------|----------|
| **Predict Pattern** | 4 | Automatically dodge next attack | Once per combat |
| **Weaken Resolve** | 3 | Enemy -2 to all rolls | 3 rounds |
| **Inspire Greatness** | 4 | Ally deals +5 damage | 3 rounds |
| **Mental Link** | 3 | Communicate telepathically with ally | 1 hour |

#### Tier 3 (Levels 7-9)

| Ability | Cost | Effect | Cooldown |
|---------|------|--------|----------|
| **Rewrite Weakness** | 6 | Ally immune to one damage type | 5 rounds |
| **Mass Suggestion** | 7 | Suggest action to up to 5 enemies | Once per day |
| **True Sight** | 5 | See through illusions, invisibility | 10 min |
| **Mind Palace** | 4 | Perfect recall of past 24 hours | Instant |

#### Tier 4 (Level 10)

| Ability | Cost | Effect | Cooldown |
|---------|------|--------|----------|
| **Absolute Truth** | 12 | Force target to answer 3 questions truthfully | Once per week |
...
| Ability | Cost | Effect | Cooldown |
|---------|------|--------|----------|
| **Phase** | 2 | Walk through walls for 1 round | 3 rounds |
| **Shadow Step** | 3 | Teleport up to 20m | 3 rounds |
| **Vanish** | 2 | Become invisible until attack | Once per combat |
| **Silent Strike** | 2 | Attack makes no sound | 1 round |

#### Tier 2 (Levels 4-6)

| Ability | Cost | Effect | Cooldown |
|---------|------|--------|----------|
| **Backstab** | 4 | Triple damage from stealth | Once per combat |
| **Void Pocket** | 3 | Store item in extradimensional space | Passive |
| **Smoke Bomb** | 3 | Create 10m radius obscurement | 5 rounds |
| **Shadow Clone** | 5 | Create illusory duplicate | 3 rounds |

#### Tier 3 (Levels 7-9)

| Ability | Cost | Effect | Cooldown |
|---------|------|--------|----------|
| **Void Walk** | 6 | Phase into Void (untargetable) for 2 rounds | Once per combat |
| **Assassinate** | 8 | Instantly kill unaware target (save or die) | Once per day |
| **Shadow Army** | 7 | Create 3 shadow clones that attack once each | Once per combat |

#### Tier 4 (Level 10)

| Ability | Cost | Effect | Cooldown |
|---------|------|--------|----------|
| **Absolute Void** | 15 | Erase existence in 10m radius (save or vanish) | Once per week |
...
| Ability | Cost | Effect | Cooldown |
|---------|------|--------|----------|
| **Manifest Weapon** | 3 | Create temporary 1d10 weapon (3 rounds) | 5 rounds |
| **Debug** | 2 | Remove one Corruption status effect | Instant |
| **Copy** | 3 | Duplicate one mundane item | Once per hour |
| **System Scan** | 2 | Detect all life/tech within 30m | 10 min |

#### Tier 2 (Levels 4-6)

| Ability | Cost | Effect | Cooldown |
|---------|------|--------|----------|
| **Reality Patch** | 5 | Change one environmental condition | 5 rounds |
| **Compile** | 4 | Create solid object (up to 1m³, lasts 10 min) | Once per hour |
| **Code Injection** | 6 | Control one enemy for 1 round (save) | Once per combat |
| **Restore** | 4 | Repair destroyed object or heal 3d8 HP | Instant |

#### Tier 3 (Levels 7-9)

| Ability | Cost | Effect | Cooldown |
|---------|------|--------|----------|
| **Fork Process** | 8 | Create temporary clone with half your stats | Once per day |
| **Refactor** | 6 | Completely reshape object (mutate/upgrade) | Once per hour |
| **Firewall** | 7 | Immunity to mental/technical attacks for 3 rounds | Once per combat |
| **Rollback** | 8 | Undo last action (time rewinds 6 seconds) | Once per day |

#### Tier 4 (Level 10)

| Ability | Cost | Effect | Cooldown |
|---------|------|--------|----------|
| **Delete** | 15 | Erase enemy from existence (no save) | Once per week |
...
**Mechanic:**
```
d20 + Mind modifier + spell tier
vs
Enemy's d20 + their Mind modifier + their spell tier
```

**Success**: Spell fails, enemy loses Spirit Points anyway
**Failure**: Enemy's spell resolves normally, you lose 2 Spirit Points
