...
Each creature file follows the template at `.claude/skills/play-agent-quest/templates/content/creature.yaml` and includes:
...
- [Combat Rules](../../../.claude/skills/play-agent-quest/rules/combat.md) - Core combat mechanics
- [Creature Template](../../../.claude/skills/play-agent-quest/templates/content/creature.yaml) - Creating new creatures
- [Battle Environment](../../../.claude/skills/play-agent-quest/templates/combat/battle-environment.yaml) - Combat arenas
...
1. Copy `.claude/skills/play-agent-quest/templates/content/creature.yaml` to appropriate category folder
